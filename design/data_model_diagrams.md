...
erDiagram
    ...
    STUDENT_EXTENDED_DATA {
        ...
        boolean is_parent_carer "Parent/carer status"
    ...
    OFFERING_TYPE {
        ...
        string name "Type name eg A-Level"
    ...
    ALPS_SUBJECT_REPORT {
        ...
        string qualification_type "A-Level or BTEC"
    ...
    SIX_DIMENSIONS_SUBJECT_REPORT {
        ...
        string academic_year "Academic year"
        string report_type "VA Sixth-Sense Vocational"
...
erDiagram
    raw_prosolution_student {
        ...
        STRING gender "Nullable - Male/Female"
    ...
    raw_prosolution_student_detail {
        ...
        STRING academic_year_id FK "Nullable - eg 23/24"
    ...
    raw_prosolution_offering_type {
        ...
        STRING description "Nullable"
        STRING category "Nullable - Academic/Vocational"
    ...
    raw_prosolution_offering {
        ...
        STRING academic_year_id "Nullable - eg 23/24"
...
erDiagram
    ...
    seed_subject_crosswalk {
        ...
        STRING mapping_method "Nullable - Exact/Fuzzy/Manual"
...
erDiagram
    ...
    GRADE {
        ...
        string grading_scale NK "Scale A*-E or D*-P"
        ...
        boolean is_grade_a_star_to_a "A* or A"
        boolean is_grade_a_star_to_b "A* to B"
        boolean is_grade_a_star_to_c "A* to C"
        boolean is_grade_a_star_to_e "A* to E"
    }
    ...
    ENROLMENT_FACT {
        ...
        string target_grade "Target grade"
        string predicted_grade "Predicted grade"
        integer is_grade_a_star "A* count 0 or 1"
        integer is_grade_a "A count 0 or 1"
        integer is_grade_b "B count 0 or 1"
    ...
    ALPS_SUBJECT_FACT {
        ...
        string alps_qualification_type "A-Level or BTEC"
    ...
    COLLEGE_PERFORMANCE_FACT {
        ...
        string academic_year_key FK "Dim reference"
        string report_type "VA or Sixth Sense"
